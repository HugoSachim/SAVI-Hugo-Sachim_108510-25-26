...
def main():
    ...
    # parser.add_argument('-qi', '--query_image', type=str, default='/home/hogu/Desktop/SAVI-Hugo-Sachim_108510-25-26/Parte04/images/machu_pichu/1.png')
    # parser.add_argument('-ti', '--target_image', type=str, default='/home/hogu/Desktop/SAVI-Hugo-Sachim_108510-25-26/Parte04/images/machu_pichu/2.png')


    parser.add_argument('-qi', '--query_image', type=str, default='images/machu_pichu/1.png')
    parser.add_argument('-ti', '--target_image', type=str, default='images/machu_pichu/2.png')

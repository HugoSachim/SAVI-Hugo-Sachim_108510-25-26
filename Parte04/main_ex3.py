...
def main():
    ...
    parser.add_argument('-qi', '--query_image', type=str, default='/home/hogu/Desktop/SAVI-Hugo-Sachim_108510-25-26/Parte04/images/castle/1.png')
    parser.add_argument('-ti', '--target_image', type=str, default='/home/hogu/Desktop/SAVI-Hugo-Sachim_108510-25-26/Parte04/images/castle/2.png')
    ...
    # desenha os N melhores matches
    N = 30
    out = cv2.drawMatches(q_image, q_key_points, t_image, t_key_points, matches[:N], None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)

    # salva ou mostra
    #cv2.imwrite("matches_simple.jpg", out)
    win_name_match = 'match'
    cv2.namedWindow(win_name_match, cv2.WINDOW_NORMAL)
    cv2.imshow(win_name_match, out)  # type: ignore
    cv2.waitKey(0)
#
# ------------------------------------
# Open the video file

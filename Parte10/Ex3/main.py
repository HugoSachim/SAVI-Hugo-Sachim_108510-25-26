...
def main():
    ...
    parser.add_argument('--dataset_pct', type=float, default=0.2, 
                    help='Percentagem de exemplos do dataset a utilizar (0-1)')
    ...
    train_dataset = Dataset(args, is_train=True, dataset_pct=args['dataset_pct'])
    test_dataset = Dataset(args, is_train=False, dataset_pct=args['dataset_pct'])

...
def main():
    ...
    parser.add_argument('-ep', '--experiment_path', type=str,
                        default='/home/hogu/Desktop/SAVI-Hugo-Sachim_108510-25-26/savi_datasets/savi_experiments',
    ...
    experiment_name = datetime.today().strftime('%Y-%m-%d %H:%M')  # same experiment every minute
